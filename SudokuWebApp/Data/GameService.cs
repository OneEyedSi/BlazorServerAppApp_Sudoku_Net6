...
namespace SudokuWebApp.Data
{
    public class GameService
    {
        ...
        public async Task<int?> SaveGameBoardAsync(Grid gameGrid)
        {
            ...
            var gameBoard = initialCells.ToGameBoard(gameGrid.IsKillerSudoku);

            dbContext.GameBoards.Add(gameBoard);
            await dbContext.SaveChangesAsync();

            return gameBoard.GameBoardId;
        }
        ...
        public int? GetExistingGameBoardId(Grid gameGrid)
        {
            ...
            // Rough first filter.
            var matchingGameBoards = dbContext.GameBoards
            ...
            foreach (var matchingBoard in matchingGameBoards)
            {
                ...
                if (isMatch)
                {
                    return matchingBoard.GameBoardId;
                }
            }
